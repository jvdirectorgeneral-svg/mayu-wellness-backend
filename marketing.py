...
def build_admin_member_payment_message(
    ...
    if payment:
        lines.extend([
            ...
            f"- Tipo: {getattr(payment, 'payment_type', '-')}",
...
def notify_admin_member_payment_event(
    ...
    labels = {
        ...
        "paypal_subscription_activation": "Nueva suscripción PayPal activa",
        "paypal_subscription_renewal": "Débito mensual PayPal confirmado",
    }
